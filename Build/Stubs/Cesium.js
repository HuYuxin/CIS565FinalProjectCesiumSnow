...
define('Scene/PostProcess', function() {
    return Cesium['PostProcess'];
});

define('Scene/PostProcessAmbientOcclusionStage', function() {
    return Cesium['PostProcessAmbientOcclusionStage'];
});

define('Scene/PostProcessBloomStage', function() {
    return Cesium['PostProcessBloomStage'];
});

define('Scene/PostProcessCompositeStage', function() {
    return Cesium['PostProcessCompositeStage'];
});

define('Scene/PostProcessDepthOfFieldStage', function() {
    return Cesium['PostProcessDepthOfFieldStage'];
});

define('Scene/PostProcessLibrary', function() {
    return Cesium['PostProcessLibrary'];
});

define('Scene/PostProcessScene', function() {
    return Cesium['PostProcessScene'];
});

define('Scene/PostProcessSilhouetteStage', function() {
    return Cesium['PostProcessSilhouetteStage'];
});
...
define('Shaders/GlobeVS.orig', function() {
    return Cesium['GlobeVS.orig'];
});
...
define('Shaders/Materials/SnowMaterial', function() {
    return Cesium['SnowMaterial'];
});
...
define('Shaders/PostProcessFilters/AmbientOcclusionGenerate', function() {
...
define('Shaders/PostProcessFilters/BloomComposite', function() {
    return Cesium['BloomComposite'];
});

define('Shaders/PostProcessFilters/Brightness', function() {
...
define('Shaders/PostProcessFilters/ContrastBias', function() {
    return Cesium['ContrastBias'];
});

define('Shaders/PostProcessFilters/DepthOfField', function() {
    return Cesium['DepthOfField'];
});

define('Shaders/PostProcessFilters/DepthView', function() {
    return Cesium['DepthView'];
});

define('Shaders/PostProcessFilters/DepthViewPacked', function() {
    return Cesium['DepthViewPacked'];
});

define('Shaders/PostProcessFilters/EdgeDetection', function() {
    return Cesium['EdgeDetection'];
});

define('Shaders/PostProcessFilters/EightBit', function() {
    return Cesium['EightBit'];
});
...
define('Shaders/PostProcessFilters/LensFlare', function() {
...
define('Shaders/PostProcessFilters/PassThroughDepth', function() {
    return Cesium['PassThroughDepth'];
});

define('Shaders/PostProcessFilters/Silhouette', function() {
    return Cesium['Silhouette'];
});

define('Shaders/PostProcessFilters/SilhouetteComposite', function() {
    return Cesium['SilhouetteComposite'];
});

define('Shaders/PostProcessFilters/SnowFalling', function() {
    return Cesium['SnowFalling'];
});

define('Shaders/PostProcessFilters/TextureOverlay', function() {
    return Cesium['TextureOverlay'];
});
